            ...
            <div class="container">
                <div class="header__wrapper">
                    ...
                    <div class="header__group">
                        ...
                        <!-- begin C:\xampp\htdocs\lalous-dev/modules/ws_signin/ws_signin.tpl --> <a href="http://localhost/lalous-dev/pl/moje-konto" title="Zaloguj się do swojego konta klienta" rel="nofollow" class="header__link header__link--create-account">
                        ...
                        <!-- begin C:\xampp\htdocs\lalous-dev/modules/ws_shoppingcart/ws_shoppingcart.tpl --><a class="header__link-icon" rel="nofollow" href="//localhost/lalous-dev/pl/koszyk?action=show" id="blockcart-wrapper">
